...
**ระบบสมัครและจัดการหลักสูตรฝึกอบรมระยะสั้นแบบครบวงจร (Production-Grade Short Course & LMS)**
...
ระบบนี้ถูกออกแบบสถาปัตยกรรมระดับองค์กร (Enterprise-Grade) โดยควบรวม 3 ระบบหลักไว้ในแพลตฟอร์มเดียว เพื่อการจัดการเรียนการสอนแบบ End-to-End:

1. **ระบบรับสมัครอัจฉริยะ (Smart Application Portal):**
   - แบบฟอร์มออนไลน์แบบ 4 ขั้นตอน (4-Step Smart Form) พร้อมระบบ Validation แบบ Real-time
   - ระบบความปลอดภัยและการจัดการสิทธิ์ตามกฎหมาย **PDPA** (Consent Lock & Versioning)
   - การเข้ารหัสข้อมูลส่วนบุคคลที่ละเอียดอ่อน (AES-256-GCM สำหรับเลขบัตรประชาชน)
   - การแจ้งเตือนอัตโนมัติผ่านอีเมล (Resend) ทั้งฝั่งผู้สมัครและผู้ดูแลระบบทันทีที่มีการส่งใบสมัคร

2. **ระบบการจัดการเรียนรู้สำหรับผู้เรียน (Student LMS Portal):**
   - ห้องเรียนออนไลน์ที่ผสานรวมวิดีโอบทเรียน (YouTube Embed) และเอกสารประกอบการเรียน
   - ระบบประเมินความรู้ผ่านแบบทดสอบ (Quizzes) พร้อมการตรวจและให้คะแนนอัตโนมัติ
   - แดชบอร์ดติดตามความคืบหน้าการเรียน (Learning Progress) ของตนเอง
   - ระบบสร้างและดาวน์โหลดใบประกาศนียบัตรออนไลน์ (Auto-Generated PDF E-Certificate) ทันทีที่ผ่านเกณฑ์

3. **แดชบอร์ดการบริหารจัดการแบบรวมศูนย์ (Admin & Staff Ecosystem):**
   - ระบบจัดการสิทธิ์แบบ **RBAC** (Role-Based Access Control) แยกสิทธิ์การทำงานระหว่าง ADMIN และ STAFF อย่างชัดเจน
   - ระบบเข้าสู่ระบบความปลอดภัยสูงผ่าน Google SSO ของมหาวิทยาลัย (`@npu.ac.th`)
   - **Learning Analytics:** หน้าปัดแสดงสถิติผู้สมัครและวิเคราะห์ทักษะดิจิทัลด้วยแผนภูมิแบบ Interactive
   - **Course Builder:** เครื่องมือสร้างและจัดการโครงสร้างหลักสูตร, บทเรียน, และแบบทดสอบ
   - **Submissions & Grading:** ระบบตรวจผลงานและให้คะแนนผู้เรียน (Assignment Review)
   - **Data Export:** ระบบส่งออกข้อมูลอย่างปลอดภัยในรูปแบบ CSV (รองรับ Excel UTF-8) และ PDF แบบพิมพ์ทันที

> [!NOTE]
> **ระบบกำลังทำงานจริงบนเซิร์ฟเวอร์ของมหาวิทยาลัยนครพนมที่:** [nextgen.npu.ac.th](https://nextgen.npu.ac.th)
...
| :------------------------- | :---------------------------------- |
| **ดร. อภิรักษ์ ทูลธรรม**   | หัวหน้าโครงการวิจัยและนักพัฒนาระบบ  |
| **อ.ยุทธภูมิ ธรรมยาฤทธิ์** | นักวิจัยและนักพัฒนาระบบ             |
| **อ.ธวัชชัย คล่องดี**      | นักวิจัยและนักพัฒนาระบบ             |
| **น.ส.ปริศนา แสงสุวรรณ**   | นักวิจัยและผู้ประสานงานโครงการวิจัย |
| **Miss Mori Minami**       | นักพัฒนาและประสานงานระบบ            |
