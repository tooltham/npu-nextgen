    ...
    <section className="relative flex min-h-[90vh] flex-col items-center justify-center overflow-hidden px-6 text-center">
      ...
      <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000">
        ...
        <div className="mt-14 flex flex-col items-center gap-6 sm:flex-row sm:justify-center">
          <Link
            href="/apply"
            className="inline-flex items-center justify-center h-16 rounded-full bg-[#1B5E20] px-12 text-lg font-semibold text-white transition-all hover:bg-[#154a19] hover:scale-105 shadow-xl shadow-green-900/10"
          >
            เริ่มใบสมัครของคุณ
          </Link>
          <Link
